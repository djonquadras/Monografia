...
\pagestyle{plain}
```{r echo=FALSE, child="C:/ProjetosGithub/Monografia/01-intro.Rmd"}
```
...
\newpage
\pagestyle{plain}
```{r echo=FALSE, child="C:/ProjetosGithub/Monografia/02-literature.Rmd"}
```
...
\newpage
\pagestyle{plain}
```{r echo=FALSE, child="C:/ProjetosGithub/Monografia/03-method.Rmd"}
```
...
\newpage
\pagestyle{plain}
```{r echo=FALSE, child="C:/ProjetosGithub/Monografia/04-results.Rmd"}
```
...
\newpage
\pagestyle{plain}
```{r echo=FALSE, child="C:/ProjetosGithub/Monografia/05-conclusion.Rmd"}
```
...
\newpage
\pagestyle{plain}
```{r echo=FALSE, child="C:/ProjetosGithub/Monografia/06-references.Rmd"}
```
